...
public class ProcessoSeletivo {
	...
	static void entrandoEmContato(String candidato) {
		...
		if(atendeu) {
			...
			System.out.println("Não conseguimos contato com " + candidato + ", númnero máximo de tentativas de " + tentativasRealizadas);
		}
	...
	static void imprimirSelecionados() {
		...
		for(int indice = 0; indice < candidatos.length; indice++) {
			System.out.println("Candidato selecionado de n° " + (indice + 1) + " é " + candidatos[indice]);
		}
	}
	
	static void selecaoCandidatos() {
		String [] candidatos = {"Felipe", "Márcia", "Julia", "Paulo", "Augusto", "Mônica", "Fabrício",
				"Mirela", "Daniela", "Jorge", "João", "Pedro", "Marcelo", "Fábio", "Maria", "Isabel"};
